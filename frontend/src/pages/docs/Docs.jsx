      ...
      <Container maxWidth='lg' sx={{ py: { xs: 4, md: 6 } }}>
        ...
        <Box id='overview' sx={{ mb: { xs: 4, md: 6 } }}>
          ...
          <Typography variant='body1' sx={{ color: '#374151' }}>
            DirtViz is an open-source platform for visualizing environmental sensor networks. It combines a modern React
            frontend with a Python backend and a relational database to stream, store, and visualize sensor data in real
            time.
          </Typography>
        </Box>
...
`}
            ...
            <Grid item xs={12} md={6}>
              ...
              <ul style={{ margin: 0, paddingLeft: 20, color: '#374151' }}>
                <li>
                  <b>TopNav / Nav</b>: responsive navigation with auth.
                </li>
                <li>
                  <b>HeroStreamingPower</b>: animated, live-like power chart.
                </li>
                <li>
                  <b>Dashboard</b>: interactive charts and filters.
                </li>
              </ul>
            </Grid>
          </Grid>
          ...
          <Box sx={{ mt: 2 }}>
            ...
            <ul style={{ margin: 0, paddingLeft: 20, color: '#374151' }}>
              <li>
                Route: <code>/dashboard</code>; responsive layout built with Material UI Grid.
              </li>
              <li>
                Charts: components under <code>frontend/src/charts</code> (e.g., <code>VwcChart</code>,{' '}
                <code>TempChart</code>, <code>PwrChart</code>), powered by Chart.js.
              </li>
              <li>
                Data fetching: TanStack Query hooks using axios clients in <code>frontend/src/services</code>.
              </li>
              <li>
                Filters: tag/cell filters and date-range utilities in <code>hooks/useSmartDateRange.js</code>.
              </li>
              <li>UX: zoom/pan plugins, downsampling, and synchronized axes for multi-chart comparisons.</li>
              <li>
                Auth-aware: protected data routes require a valid access token; handled by <code>useAxiosPrivate</code>.
              </li>
            </ul>
          </Box>
        </Box>
...
FLASK_ENV=production`}
        ...
        <Box id='setup' sx={{ mb: { xs: 4, md: 6 } }}>
          ...
          <ol style={{ margin: '12px 0 0 20px', color: '#374151' }}>
            ...
            <li>
              Connect to <strong>ents-xxx</strong>. If the board has not been configured it will show{' '}
              <strong>ents-unconfigured</strong>. Otherwise <strong>xxx</strong> will be replaced by the{' '}
              <em>Logger ID</em>. One minute after the first upload the WiFi network will turn off to save power if no
              one is currently connected. Repeat Step 1 in this case.
            </li>
            <li>
              Navigate to{' '}
            ...
            <li>
              Press the reset button (top right white button) for the EnTS board to start using the new configuration.
            </li>
          </ol>
        </Box>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            ...
            <Box
              component='pre'
              sx={{ m: 0, p: 2, background: '#F9FAFB', border: '1px solid #E5E7EB', borderRadius: 1, overflow: 'auto' }}
            >
              {`cd frontend
npm install
npm run dev`}
        ...
        <Box id='learn' sx={{ textAlign: 'center', mb: { xs: 2, md: 4 } }}>
          <Stack direction='row' spacing={2} sx={{ justifyContent: 'center' }}>
            <Button
              ...
              rel='noreferrer'
              variant='contained'
              sx={{ backgroundColor: '#111827', color: '#FFFFFF', textTransform: 'none', fontWeight: 800 }}
            >
              View on GitHub
            </Button>
            <Button
              ...
              rel='noreferrer'
              variant='text'
              sx={{ color: '#111827', textTransform: 'none', fontWeight: 800 }}
            >
              Read Research Paper
            </Button>
          </Stack>
