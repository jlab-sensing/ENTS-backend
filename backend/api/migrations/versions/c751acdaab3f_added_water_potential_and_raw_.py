...
def upgrade():
    ...
    op.add_column(sa.Column("raw_vwc", sa.Float(), nullable=True))
    op.add_column(sa.Column("water_pot", sa.Float(), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("water_pot")
    op.drop_column("raw_vwc")
