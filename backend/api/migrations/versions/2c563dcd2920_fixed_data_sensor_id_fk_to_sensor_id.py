...
def upgrade():
    ...
    with op.batch_alter_table('data', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(None, 'sensor', ['sensor_id'], ['id'], ondelete='CASCADE')
...
def downgrade():
    ...
    with op.batch_alter_table('data', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('data_sensor_id_fkey', 'cell', ['sensor_id'], ['id'], ondelete='CASCADE')
